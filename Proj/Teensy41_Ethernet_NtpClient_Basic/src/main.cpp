// Ethernet_NTPClient_Basic library, setting adapted to Teesny 4.1 by RoSchmi
// For other boards use the original files from Khoi Hoang https://github.com/khoih-prog/NTPClient_Generic
